...
class Database2Result
{
    ...
    function execute() {
        ...
        if ( $this->parent ) {
            ...
            // restrict to parent
            $this->where[] = $this->db->is( $this->key, $this->parent->getGlobalKeys( $this->parentKey ) );
        ...
        if ( !$this->parent ) {
            ...
            $this->rows = array();
            $keys = $this->parent->getLocalKeys( $this->parentKey );
    ...
    function update( $data ) {
        ...
        if ( $this->parent || isset( $this->limitCount ) ) {
